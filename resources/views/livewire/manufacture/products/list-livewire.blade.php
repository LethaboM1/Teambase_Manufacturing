         ...
         <section class="card">
             ...
             <div class="card-body">
                 ...
                 <div class="tab-content">
                     <div class="tab-pane {{ $tab == 'all' ? 'active' : '' }}" id="all" role="tabpanel"
                         aria-labelledby="all-tab">

                         <div class="header-right">
                             {{-- <form action="#" class="search nav-form"> --}}
                             <div class="input-group">
                                 <input type="text" class="form-control" name="search" wire:model.debounce="search"
                     ...
                     <div class="tab-pane {{ $tab == 'recipe' ? 'active' : '' }}" id="recipe" role="tabpanel"
                         ...
                         <div class="header-right">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" name="search_recipe"
                                     wire:model.debounce="search_recipe" placeholder="Search Product...">
                                 <button class="btn btn-default" type="submit"><i class="bx bx-search"></i></button>
                             </div>
                             {{-- </form> --}}
                         </div>
                     ...
                     <div class="tab-pane {{ $tab == 'raw' ? 'active' : '' }}" id="raw" role="tabpanel"
                         aria-labelledby="raw-tab">

                         <div class="header-right">
                             {{-- <form action="#" class="search nav-form"> --}}
                             <div class="input-group">
                                 <input type="text" class="form-control" name="search_raw"
                                     wire:model.debounce="search_raw" placeholder="Search Product...">
                                 <button class="btn btn-default" type="submit"><i class="bx bx-search"></i></button>
                             </div>
                             {{-- </form> --}}
                         </div>
