<tr class="pointer">
    ...
    <td>
        @if ($dispatchaction == "new")
            <a id="edit_btn_{{$dispatch->id}}" href="#editDispatch_{{$dispatch->id}}" class="btn btn-primary btn-sm modal-basic">
        ...
        @else
            ...
            {{-- <a id="return_btn_{{$dispatch->id}}" href="#returnDispatch_{{$dispatch->id}}" class="btn btn-primary btn-sm modal-basic">
                <i class="fas fa-rotate-left"></i>                    
            </a> removed due to out of time 2023-09-13 --}}
        @endif                                          
