<form wire:submit.prevent='dispatch' enctype='multipart/form-data'>
        @csrf
        <section class='card'>
            <header id='addDispatchAdditionalHeader' class='card-header'><h2 class='card-title'>Begin New Dispatch.</h2></header>                                
                <div class='card-body'>
                                        ...
                                        <thead>
                                            ...
                                            @if($add_extra_item_show == '1')
                                                <tr>   
                                                    ...
                                                    <td>
                                                        <a wire:click="AddExtraItem" class="btn btn-primary btn-sm" title="Add Item">
                                                            <i class="fas fa-plus"></i>                    
                                                        </a>
                                            ...
                                            @if(count($extra_items)>0)
                                                ...
                                                <tr>   
                                                    ...
                                                    <td>                            
                                                        <a wire:click="removeExtraItem({{$key}})" class="btn btn-primary btn-sm" title="Remove Item">
