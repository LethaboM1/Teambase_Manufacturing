                ...
                <div class='row'>
                    <div class='col-md-12 text-right'>
                        @if ($dispatchaction == "new")
                            ...
                            <a id="edit_btn_{{$dispatch->id}}" href="#delete_{{$dispatch->id}}" class="btn btn-danger modal-basic" title="View Archived Dispatch">Delete</a>
                            ...
                            <div id='delete_{{$dispatch->id}}' class='modal-block modal-block-lg mfp-hide'>
                                <form method='post' enctype='multipart/form-data'>
                                    @csrf
                                    <section class='card'>
                                        <header id='delete_{{$dispatch->id}}header' class='card-header'><h2 class='card-title'></h2></header>
                                            <div class='card-body'>
                                                <div class='modal-wrapper'>
                                                    <div class='modal-text'>
                                            ...
                                            <footer class='card-footer'>
                                                <div class='row'>
                                                    <div class='col-md-12 text-right'>
                                                        <a class='btn btn-success btn-sm'  href="{{url("dispatches/delete/{$dispatch->id}")}}">Yes</a>
