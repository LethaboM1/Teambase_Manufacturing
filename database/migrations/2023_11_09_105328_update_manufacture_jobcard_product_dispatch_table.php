...
return new class extends Migration
{
    ...
    {
        Schema::table('manufacture_jobcard_product_dispatches', function (Blueprint $table) {
            $table->bigInteger('product_id')->after('customer_id')->default(0);
            $table->bigInteger('manufacture_jobcard_product_id')->after('product_id')->default(0);
            $table->bigInteger('batch_id')->after('manufacture_jobcard_product_id')->default(0);                        
            $table->float('qty', 6,2)->after('batch_id')->nullable();
